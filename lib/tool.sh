...
_工具_清除配置() {
    ...
    unset NAPCAT_ZIP_URL NAPCAT_LAUNCHER NAPCAT_CONFIG_DIR QQ_ROOT
    unset NAPCAT_QQ_DIR NAPCAT_PREFS_FILE NAPCAT_LAST_ERR
    unset CONFIG_DIR QQ_PACKAGE_JSON QQ_MAIN_ORIGINAL LOAD_NAPCAT_JS QQ_BIN
    unset TOOL_DEPS
    TOOL_DEPS=()
}
